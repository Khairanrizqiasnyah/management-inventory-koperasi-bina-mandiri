...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('category.add') }}" class="btn btn-warning btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Category </i></a> <br>  <br>               
