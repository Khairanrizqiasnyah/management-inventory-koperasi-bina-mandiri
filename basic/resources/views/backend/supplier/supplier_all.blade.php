...
@section('admin')
 ...
 <div class="page-content">
    ...
    <div class="row">
     ...
     <a href="{{ route('supplier.add') }}" class="btn btn-warning btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Supplier </i></a> <br>  <br>               
