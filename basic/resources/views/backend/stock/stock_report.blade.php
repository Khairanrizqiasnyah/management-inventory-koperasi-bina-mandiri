...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('stock.report.pdf') }}" target="_blank" class="btn btn-warning btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> Stock Report Print </i></a> <br>  <br>               
                    ...
                    @endphp
                       <tr>
                            ...
                            <td> <span class="btn btn-info"> 0</span> </td> 
