...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('purchase.add') }}" class="btn btn-warning btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Purchase </i></a> <br>  <br>              
