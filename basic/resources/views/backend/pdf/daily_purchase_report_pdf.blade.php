    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_koperasi2.png') }}" alt="logo" height="24"/> Koperasi Bina Mandiri
                </h3>
            </div>
            <hr>
      ...
      @php
        ...
        <tr>
           <td class="text-center">{{ $key+1 }}</td>
            ...
            <td class="text-center">Rp. {{ $item->unit_price }}</td>
            <td class="text-center">Rp. {{ $item->buying_price }}</td>
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">Rp. {{ $total_sum}}</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
